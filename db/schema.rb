...
ActiveRecord::Schema.define(version: 20160221223450) do
  ...
  add_index "staffs", ["ni"], name: "index_staffs_on_ni", unique: true, using: :btree
  add_index "staffs", ["staff_no"], name: "index_staffs_on_staff_no", unique: true, using: :btree
